...
@Component({
  selector: 'app-cahierclause-finan-view-one',
  templateUrl: './cahierclause-finan-view-one.component.html',
  styleUrls: ['./cahierclause-finan-view-one.component.css']
})
export class CahierclauseFinanViewOneComponent implements OnInit {
