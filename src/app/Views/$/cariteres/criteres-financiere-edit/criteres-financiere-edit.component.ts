...
@Component({
  selector: 'app-criteres-financiere-edit',
  templateUrl: './criteres-financiere-edit.component.html',
  styleUrls: ['./criteres-financiere-edit.component.css']
})
export class CriteresFinanciereEditComponent implements OnInit {
  ...
  ccf=new Criterescahierclausesfinancierestechniques();
  ...
  ngOnInit(): void {
    ...
    this.activated.paramMap.subscribe(
      d=>{
        ...
        this.critereFinancierService.getOneCriterescahierclausesfinancierestechniquestype(id1,id2).subscribe(
          d=>{
            this.ccf=d;
            console.log("-/-/-/-/-/-/-/-/-/->"+this.ccf.criteresCahierClausesFinancieresTechniquesBareme)
            }
        )  
      }
    );
...
onSubmit(): void {
  ...
  this.critereFinancierService.updadteCritereFinan(this.ccf).subscribe(
